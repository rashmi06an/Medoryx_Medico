      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500">Pharmacy Control Center</p>
          </div>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div
            ...
            className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-transparent hover:border-blue-50"
          >
            <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors duration-300 shadow-sm">
              <FiBox className="text-2xl text-blue-600 group-hover:text-white transition-colors duration-300" />
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-blue-700 transition-colors">Manage Inventory</h3>
            <p className="text-gray-500 leading-relaxed mb-4">
              Add new medicines, update stock levels, and track batch numbers.
            </p>
            <span className="text-blue-600 font-semibold group-hover:underline flex items-center gap-2 text-sm">
              Open Inventory &rarr;
            </span>
          </div>
